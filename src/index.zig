...
pub const cedar_workbench = @import("viewmodel/cedar_workbench.zig");
...
pub const CedarCli = @import("services/CedarCli.zig").CedarCli;
pub const cedar_cli = @import("services/CedarCli.zig");
