...
pub const UDPRouteRecord = @This();

key: keys.ObjectKey,
parent: []u8,
creation_timestamp: ?[]u8 = null,

pub fn fromUDPRoute(allocator: std.mem.Allocator, value: klient.UDPRoute) !UDPRouteRecord {
...
pub fn clone(self: UDPRouteRecord, allocator: std.mem.Allocator) !UDPRouteRecord {
...
pub fn deinit(self: *UDPRouteRecord, allocator: std.mem.Allocator) void {
...
pub fn columns(self: *const UDPRouteRecord, allocator: std.mem.Allocator) ![4][]const u8 {
