...
pub const GRPCRouteRecord = @This();
...
pub fn fromGRPCRoute(allocator: std.mem.Allocator, value: klient.GRPCRoute) !GRPCRouteRecord {
...
pub fn clone(self: GRPCRouteRecord, allocator: std.mem.Allocator) !GRPCRouteRecord {
...
pub fn deinit(self: *GRPCRouteRecord, allocator: std.mem.Allocator) void {
...
pub fn columns(self: *const GRPCRouteRecord, allocator: std.mem.Allocator) ![5][]const u8 {
