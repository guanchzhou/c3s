...
pub fn fromTLSRoute(allocator: std.mem.Allocator, value: klient.TLSRoute) !TLSRouteRecord {
...
pub fn clone(self: TLSRouteRecord, allocator: std.mem.Allocator) !TLSRouteRecord {
...
pub fn deinit(self: *TLSRouteRecord, allocator: std.mem.Allocator) void {
...
pub fn columns(self: *const TLSRouteRecord, allocator: std.mem.Allocator) ![5][]const u8 {
